  ...
  return (
    <div className="py-12 px-6">
      <div className="text-center max-w-3xl mx-auto mb-16">
        ...
        <p className="text-muted-foreground text-lg">Choose the plan that fits your SEO needs. Upgrade or downgrade at any time.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
        {tiers.map((tier) => (
          <Card key={tier.name} className={`bg-card/40 backdrop-blur-sm border-white/5 shadow-xl flex flex-col ${tier.primary ? 'ring-2 ring-primary border-primary/50 scale-105 z-10' : ''}`}>
            <CardHeader>
            ...
            <CardContent className="flex-1 flex flex-col">
              ...
              <Button 
                className={`w-full ${tier.primary ? 'bg-primary hover:bg-primary/90' : 'bg-white/5 hover:bg-white/10 border-white/10'}`}
